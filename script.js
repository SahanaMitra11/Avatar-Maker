			...
			switch (idx) {
				...
				case "backgroundcolors":
					for (var i = 0; i < backgroundcolors.length; i++) {
						...
						html +=
							"<div class='backgroundcolors' id='g_" +
							backgroundcolor +
							"' style='background-color:#" +
							backgroundcolor +
							";'></div>";
...
function random() {
	...
	var rand_glassopacities =
		parseInt(glassopacities[Math.floor(Math.random() * glassopacities.length)]) /
		100;
